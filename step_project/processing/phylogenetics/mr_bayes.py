...
from step_project.steps.phylogenetics import MrBayesStep, MrBayesSteps
...
def create_mr_bayes_data(step_data, alignment_step, cache, run):
    ...
    if alignment_step._IS_COLLECTION:
        step = MrBayesSteps(alignment_step.zcit, step_data, remove_data=True)
        ...
        step = MrBayesStep(alignment_step.zcit, step_data, remove_data=True)
