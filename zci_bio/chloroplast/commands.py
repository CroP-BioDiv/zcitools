...
class ChloroplastAlign(CreateStepFromStepCommand):
    ...
    def set_arguments(parser):
        ...
        parser.add_argument('-a', '--to-align', default='whole',
                            help='What to align. Options: whole, parts, trnH-GUG. Format: "opt1:opt2:...". ' +
                                 'Only first character is needed.')
    ...
    def run(self, step_data):
        ...
        return chloroplast_alignment(
            ...
            args.sequences, self._to_align(), self.run, args.alignment_program)
