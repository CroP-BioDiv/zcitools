...
def org_annotate(seq_filename, print_repseek_output=False, print_blast_output=False, leave_tmp_file=False):
    ...
    oa_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'ORGAnnotate')
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description="Run ORG.Annotate IR detection on sequence stored as fasta or genbank file.")
    ...
    print(org_annotate(params.seq_filename,
